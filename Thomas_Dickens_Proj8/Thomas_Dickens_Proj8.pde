...
void setup(){
  ...
  //// PieChart
  pieChart2014 = new PieChartView(controller, dataImport.avgPrecip, dataImport.dttm, 2014, new PVector(150,200));


  pieChart2015 = new PieChartView(controller, dataImport.avgPrecip, dataImport.dttm, 2015, new PVector(500,200));
